    ...
    <Wrapper>
      <Container>
        <Row className="justify-content-md-center">
          <Col xs={12} sm={9}>
            <H6>
              Please fill out the form to add a new page and then click
              the submit button.
            </H6>
          </Col>
        </Row>
        <Row className="justify-content-md-center">
          <Col xs={12} sm={9}>
            <Card>
              <StyledCardHeader>Add Page Details</StyledCardHeader>
              <Card.Body>
                <Form onSubmit={handleSubmit}>
                  <Form.Group controlId="addName">
                    <Form.Label>PageName</Form.Label>
                    <Form.Control
                      required
                      type="text"
                      name="name"
                  ...
                  <Form.Group controlId="addProfession">
                    ...
                    <Form.Control
                      ...
                      type="text"
                      name="profession"
                      placeholder="Please enter the page type"
                  ...
                  <Form.Group controlId="addCity">
                    <Form.Label> Page Technology</Form.Label>
                    <Form.Control
                      required
                      type="text"
                      name="city"
                  ...
                  <Form.Group controlId="addBranch">
                    <Form.Label>SEO Page Ranking</Form.Label>
                    <Form.Control
                      required
                      type="text"
                      name="branch"
